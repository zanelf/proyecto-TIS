...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <h1 class="fw-bold text-dark m-0">Tipos de Solicitudes</h1>
            <button type="button" class="btn btn-success fw-medium shadow-sm px-4" data-bs-toggle="modal" data-bs-target="#modalNuevoTipoSolicitud">
    ...
    <div class="modal fade" id="modalNuevoTipoSolicitud" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 12px;">
                <div class="modal-header border-0 pb-0">
                    <h5 class="fw-bold text-dark m-0">Nuevo Tipo de Solicitud</h5>
