...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2026 a las 03:54:47
...
INSERT INTO `solicitud` (`solicitud_ID`, `Tipo_estado`, `Asunto`, `Descripcion`, `RUT_ciudadano`, `ID_departamento`, `ID_tipo_solicitud`) VALUES
(1, 'Felicitaciones', 'fdfdf', '', 434, 0, 0),
(5, 'Felicitaciones', 'fdfdf', 'ff', 45, 1, 4),
(6, 'Felicitaciones', 'fdfdfasdaf', 'gdfgdfg', 45, 2, 4);
